...
| <a name="input_vpc_name"></a> [vpc\_name](#input\_vpc\_name) | Name of the VPC where the Endpoint Gateways will be created. This value is used to generate VPE names dynamically and must be specified before applying the changes. | `string` | `"vpc"` | no |
