...
* [Examples](./examples)
    ...
    * [Basic multi-tenant VPE gateway](./examples/basic-crn)
...
| <a name="input_region"></a> [region](#input\_region) | The region where VPC and services are deployed | `string` | `"ca-mon"` | no |
