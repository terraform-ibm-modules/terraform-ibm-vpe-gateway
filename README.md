...
[![Terraform Registry](https://img.shields.io/badge/terraform-registry-623CE4?logo=terraform)](https://registry.terraform.io/modules/terraform-ibm-modules/vpe-gateway/ibm/latest)
...
<ul>
  ...
  <li><a href="https://github.com/terraform-ibm-modules/terraform-ibm-vpe-gateway/tree/main/modules">Submodules</a>
    <ul>
      <li><a href="https://github.com/terraform-ibm-modules/terraform-ibm-vpe-gateway/tree/main/modules/reserved-ips">reserved-ips</a></li>
    </ul>
  </li>
  <li><a href="https://github.com/terraform-ibm-modules/terraform-ibm-vpe-gateway/tree/main/examples">Examples</a>
    <ul>
      <li>
        <a href="https://github.com/terraform-ibm-modules/terraform-ibm-vpe-gateway/tree/main/examples/advanced">Advanced dedicated service VPE gateway</a>
      ...
      <li>
        <a href="https://github.com/terraform-ibm-modules/terraform-ibm-vpe-gateway/tree/main/examples/basic">Basic multi-tenant VPE gateway</a>
      ...
      <li>
        <a href="https://github.com/terraform-ibm-modules/terraform-ibm-vpe-gateway/tree/main/examples/every-multi-tenant-svc">Every supported multi-tenant ("provider_cloud_service") VPE gateway</a>
  ...
  <li><a href="https://github.com/terraform-ibm-modules/terraform-ibm-vpe-gateway/tree/main/solutions">Deployable Architectures</a>
    <ul>
      <li><a href="https://github.com/terraform-ibm-modules/terraform-ibm-vpe-gateway/tree/main/solutions/fully-configurable">Deploy Virtual Private Endpoint (VPE) gateways to Virtual Private Cloud (VPC)</a></li>
    </ul>
  </li>
...
module "vpes" {
  ...
  region            = "us-south"
  prefix            = "my-prefix"
  vpc_name          = "my-vpc"            # used for VPE name generation (e.g. "<prefix>-my-vpc-kms"); not a VPC lookup key
...
| <a name="input_resource_tags"></a> [resource\_tags](#input\_resource\_tags) | Add user resource tags to the VPE to organize, track, and manage costs. [Learn more](https://cloud.ibm.com/docs/account?topic=account-tag&interface=ui#tag-types). | `list(string)` | `[]` | no |
...
| <a name="output_gateway_ids"></a> [gateway\_ids](#output\_gateway\_ids) | Map of gateway name to gateway ID for all created endpoint gateways |
| <a name="output_vpe_ips"></a> [vpe\_ips](#output\_vpe\_ips) | The endpoint gateway reserved ips. For adopted gateways (existing\_vpe\_id set), only the reserved IPs created by this module invocation are returned. |
